...
# Making array of all ground truths as it is without any cropping. Padding all images
...
#Another way of visualising the image
%matplotlib inline 
...
base_model = Unet(backbone_name='resnet34', classes = 6, activation='softmax', encoder_weights='imagenet', freeze_encoder=True)
N = trainx.shape[-1]
